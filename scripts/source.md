...
| `source_identity.sh` | Computes the stable source-tree identity used by Phase 011 report, manifest, and aggregate adapters. | Ignores Git/task/artifact/build outputs; reads source files only and does not change product runtime state. |
