...
class ReleaseMetadataContractTest(unittest.TestCase):
    def test_current_offline_compose_candidate_metadata_is_v014_before_tagging(self) -> None:
        ...
        self.assertIn("v0.1.4 candidate metadata", current_state)
        self.assertIn("but has no `v0.1.4` tag", current_state)
